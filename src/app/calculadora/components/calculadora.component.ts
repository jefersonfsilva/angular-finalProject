...
export class CalculadoraComponent implements OnInit {
	...
	private operacao: string;
  	...
  	*/
  	...
  	/**
  	* Adiciona o número selecionado para o cálculo porteriormente.
  	*
  	* @param string numero
  	* @return void
  	*/
  	...
  	/**
  	* Retorna um valor concatenado. Trata o separador decimal.
  	* 
  	...
  	*/
  	definirOperacao(operacao: string): void {
  		...
  		//caso operação definida e número 2 selecionado, efetua cálculo
